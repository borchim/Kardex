...
export const socialPlatformsConfig: SocialPlatform[] = [
  ...
  // Turkey Real Estate Portals
  { value: 'sahibinden', label: 'Sahibinden.com', category: 'realestate', color: '#FF6600', placeholder: 'https://sahibinden.com/ilan/username' },
  { value: 'hurriyet-emlak', label: 'Hürriyet Emlak', category: 'realestate', color: '#E30613', placeholder: 'https://hurriyet.com.tr/emlak/username' },
  { value: 'zingat', label: 'Zingat', category: 'realestate', color: '#00AEEF', placeholder: 'https://zingat.com/username' },
  { value: 'emlakjet', label: 'Emlakjet', category: 'realestate', color: '#F26522', placeholder: 'https://emlakjet.com/username' },
  { value: 'emlaksepeti', label: 'EmlakSepeti', category: 'realestate', color: '#8DC63F', placeholder: 'https://emlaksepeti.com/username' },
...
export const socialPlatformCategories = [
  ...
  { value: 'realestate', label: 'Real Estate Portals' },
